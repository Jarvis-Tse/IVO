...
ui <- fluidPage(
  ...
  div(
    ...
    fluidRow(
      column(4,
        textInput("filter_term", "Filter by Term:", 
                  value = root_item_name, width = "100%")
      ),
      column(2,
        checkboxInput("enable_filter", "Enable Term Filtering", value = FALSE)
      ),
      column(3,
        textInput("highlight_term", "Identify Term:", 
                  value = root_item_name, width = "100%")
      ),
      column(3,
        checkboxInput("use_highlight_term", paste0("Use highlight term"), value = FALSE)
      )
    )
  ),
 ...
 # Legend for node shapes
  div(
    ...
    div(style = "margin-bottom: 8px;",
      ...
      span("Leaf nodes (with # of unshown descendant levels)", style = "color: #333; vertical-align: middle;")
    ),
    div(style = "margin-bottom: 8px;",
      ...
      span("Non-leaf nodes", style = "color: #333; vertical-align: middle;")
    ),
    ...
    div(style = "margin-bottom: 8px;",
      ...
      span("Sibling with low a granularity", style = "color: #333; vertical-align: middle;")
    ),
    div(style = "margin-bottom: 8px;",
    ...
    div(style = "margin-bottom: 0px;",
      ...
      span("Highlighted term", style = "color: #333; vertical-align: middle;")
    )
  ),
